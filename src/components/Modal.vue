      ...
      <div class="modal-wrapper">
        ...
        >
          ...
          <div id="preview" class="flex flex-col py-8">
            ...
            />
            <div
              class="flex flex-row ml-12 justify-center align-middle w-full max-h-fit my-4"
            >
              <div
            ...
            <div
              class="flex flex-col self-start max-w-full h-10 divide-y-2 divide-tangerine-400"
              v-for="comment in post.comments"
            >
              <div class="flex flex-row px-4 w-full items-center">
                <svg
                  class="flex-initial ml-28 pr-2 align-middle w-8 h-8 text-tangerine-400 card"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <path
